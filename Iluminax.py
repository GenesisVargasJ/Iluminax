...
class Iluminax():
	...
	def on_BtnBajo_clicked(self, button):
		self.CambiarBrilloPantalla(70, "pantalla1.png")
	
	def on_BtnMedio_clicked(self, button):
		self.CambiarBrilloPantalla(85, "pantalla2.png")
	
	def on_BtnAlto_clicked(self, button):
		self.CambiarBrilloPantalla(100, "pantalla3.png")
	...
	#procedimiento que hace un subproceso para detectar el dispositivo de pantalla
